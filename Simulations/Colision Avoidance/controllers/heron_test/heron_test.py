...
# ===== AUTOPILOT SETTINGS =====
BASE_SPEED = 6.0          # prędkość bazowa
TURN_GAIN = 2.5           # wzmocnienie skrętu (P)
MAX_SPEED = 9.0           # ograniczenie prędkości silników
SLOW_DIST = 3.0           # dystans do celu, od którego zwalniamy
STOP_DIST = 0.8           # promień "dotarcia do celu"

OBSTACLE_DIST = 2.0       # jeśli "front" bliżej niż to, omijamy
AVOID_TURN = 1.5          # ile dodajemy do skrętu podczas omijania

# ===== PRINT TIMER =====
PRINT_INTERVAL = 0.5
time_acc = 0.0

# ===== AVOIDANCE STATE (GLOBAL) =====
AP_MODE = "GO"          # "GO", "AVOID", "ESCAPE"
AVOID_SIDE = None       # "LEFT" lub "RIGHT"
AVOID_HOLD = 0.0        # sekundy blokady skrętu
ESCAPE_HOLD = 0.0       # sekundy cofania/ucieczki
...
def autopilot_step(
    ...
    ESCAPE_TRIGGER = 2.0                   # bardzo blisko – zwykle kolizja / kontakt
